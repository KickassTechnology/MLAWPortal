...
{
    public partial class Get_800_Order_Slice : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            //Returns a list of Custom/Commercial Orders based on Filters
            ...
            DAL dal = new DAL();
            DataSet ds = dal.get800OrderSlice(strStatuses, iDateType, strStartDate, strEndDate);
