<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Delivery_Default.aspx.cs" Inherits="MLAW_Order_System.DeliveryPortal.Delivery_Default" %>
                ...
                <div id="header_filters">
                    <div style="width:100%;text-align:left;border-top:1px solid #5a5a5a;border-bottom:1px solid #5a5a5a;min-height:40px;" id="order_types">
                        ...
                        <div style="width:300px;float:right;height:20px;">
                            ...
                            <div style="float:left;padding-top:10px;"><input type="button" onclick="setFoundationOrderStatus(10)" value="mark as delivered"/></div>
                            <div style="clear:both"></div>
                        </div>
